## Header ----
    ...
    # R version: 4.3.1
    # Purpose: append and prep all individual PULSE 3.10 survey files for analysis
    #
    ...
    #
    # Notes: Phase 3.10 began with week 61 (Aug 23 - Sept 4, 2023) and is scheduled to continue for two additional survey weeks.
    #        The survey has multiple changes compared to Phase 3.9 including the following which impact this analysis:
    #        ---NEW VARS---
    #        D2: Original Hispanic origin question. This question replaced the previously combined
    #        race/ethnicity question. This question asks respondents to indicate Hispanic, Latino, or
    #        Spanish origin.        
    #
    #        D3: Original race question. This question asks respondents to indicate and specify their
    #        race. This question replaces the previously combined race/ethnicity question.        
    #
    #        D7_ALT: Gender. This question replaced the previous gender question. This question asks
    #        respondents to describe what gender identity they currently use to describe themselves.        
    #
    #        HLTH14: Children’s mental health behaviors. This new question asks about certain behaviors
    #        related to mental health that have been exhibited by children in the household.        
    #
    #        ---CHANGED VARS---
    #        D13: Education enrollment. This question has been updated to reflect the current school term of 
    #        Summer/Fall 2023
    #
    #        HLTH8: Health insurance/plan coverage. This question has been moved to appear after the difficulty 
    #        communicating question (DIS6)
    #
    #        HSE7rev: Pressure to move. The universe for this question has been revised to be limited to renters 
    #        only
    #
    #        ND5E: Feeling isolated. This question has been further specified to include feeling “down, depressed, 
    #        anxious, nervous or on edge.”
    #       
    #        MEDICAID_1: Medicaid coverage. This question has been moved to appear after the newly moved 
    #        question about health insurance/plan coverage
    # 
    #        MEDICAID_2: Reason for Medicaid termination. This question has been moved with the medical 
    #        coverage question. 

    #        ---DROPPED VARS---
    #        Race_combined, Race_multistep, [Race]_detail: Race and ethnicity questions. These questions have
    #        been replaced by the original race/ethnicity questions (D2, D3). These questions asked for a 
    #        respondents’ detailed race and ethnicity origins, including specific ethnicities and races
    #        
    #
            ...
            # Medicaid ----
              ...
              dt[, medicaid_no := factor(medicaid_no, 
                                         ...
                                         labels = c("I gained new coverage and chose to drop Medicaid", 
                                                    ...
                                                    "I tried to stay in Medicaid, but I could not complete the renewal process", 
                                                    "Missing response"))]
              dt[, medicaidv2 := factor(medicaid, 
                                      levels = 1:2, 
                                      labels = c("Yes, I had Medicaid coverage but I no longer have it", 
                                                 "No, I have not had Medicaid since January 1, 2022"))]
              
              dt[!is.na(medicaid), medicaid1 := 'Other'][medicaidv2 == "Yes, I had Medicaid coverage but I no longer have it", medicaid1 := medicaidv2]
              ...
              dt[!is.na(medicaid), medicaid3 := 'Other'][medicaidv2 == "No, I have not had Medicaid since January 1, 2022", medicaid3 := medicaidv2]
