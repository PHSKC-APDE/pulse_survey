## Header ----
    ...
    #
    # Notes: Phase 4_1 is similar to Phase 4_0, except for support4 >> support4_rv
    #
    # Needs rads >= v1.0.0
    #
...
## Set up ----
    ...
    # set constants ----
      ...
      first.cycle <- 4 # identify the first cycle of the current phase
...
## Identify columns for calculations ----
    ...
    health_vars <- c("down", "anxious", "worry", "interest", 
                     ...
                     "social1", "social2", "support1", "support2", "support3", "support4_rv", "support1exp")
