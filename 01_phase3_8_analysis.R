## Header ----
    ...
    #
    # Notes: Phase 3.8 differs from previous phases and will be analyzed separately
    #        refer to notes in 00_phase3_8_prep_survey.R for details. 
    #        Phase 3.8 begins with week 55 (March 1-13, 2023)
    #
    # Needs rads >= v1.0.0
...
## Set up ----
    ...
    # set constants ----
    phase.number <- "3.8"
    phase_number <- "3_8" # have to give this value a second time because creating the analysis dataset
    first.week <- 55 # identify the first week of the current phase
