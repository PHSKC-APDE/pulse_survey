## Header ----
    ...
    # Date: June 22, 2022
    # R version: 4.1.2
    # Purpose: append and prep all individual PULSE 3.5 survey files for analysis
    #
    ...
    #
    # Notes: Phase 3.5 began with week 46 (06/01/2022-06/13/2022) and is scheduled to continue until August 17, 2022.
    #        Like, Phases 3.3 & 3.4, 3.5 has a "two weeks on, two weeks off" sampling scheme.
    #        Many questions were added, changed, and deleted when compared to 3.4. When possible, attempts
...
## Prepare data ----
    ...
    # create variables ----
        ...
        # Vaccine ----      
          ...
          # QV3
          # After Phase 3.4 do not have getvacrv so cannot create definitevacc
          ...
          # After Phase 3.4, brand is no longer available
          # After Phase 3.4 KIDDOSES_12_17y & KIDDOSES_5_11y are no longer available  
