## Header ----
    ...
    # Date: July 17, 2023
    # R version: 4.2.1
    # Purpose: append and prep all individual PULSE 3.9 survey files for analysis
    #
    ...
    #
    # Notes: Phase 3.9 began with week 58 (June 7-19, 2023) and is scheduled to continue for two additional survey weeks.
    #        The survey has multiple changes compared to Phase 3.8 including the following which impact this analysis:
    #        ---NEW VARS---
    #        RACE_SP > Hispanic as race, now replaces RRACE & RHISPANIC which were combined into one question, 
    #                  however, the census bureau doesn't actually provide race_sp, but rather provides 
    #                  rrace and rhispanic, so there is no change in the coding
    #        MH1-MH4 > need for, receipt of, satisfaction with, and difficulty in obtaining mental health treatment for children
    #        HSE7rev > pressure to move
    #        HSE7b > moved due to pressure to move
    #        
    #        ---CHANGED VARS---
    #        MEDICAID > dropped "Yes, I currently have Medicaid coverage", which is level 2 of the factor, factor coding changed
    #        swapped order of DIS3 (diff concentrating/remembering) and DIS4 (diff stairs), so now ask DIS 4 first ... no coding changes
    #
    #        ---DROPPED VARS---
    #        trentamt (total current payments)
    #        K12ED1 (how children received education)
    #
