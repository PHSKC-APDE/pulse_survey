## Header ----
    ...
    # Date: January 5, 2023
    # R version: 4.2.1
    # Purpose: append and prep all individual PULSE 3.7 survey files for analysis
    #
    ...
    #
    # Notes: Phase 3.7 began with week 52 (9-Dec-2022 <> 19-Dec-2022) and is scheduled to continue two additional survey weeks.
    #        Many questions were added, changed, and deleted when compared to 3.6. When possible, attempts
    #        were made to keep indicators consistent across time. No attempt was made to incorporate every new
    #        question
    # 
    #        We added following indicators for Phase 3.7
    #         * medicaid < Since Jan 1, 2022, have you ever had Medicaid?
    #         * medicaid_no < What was the main reason you no longer have Medicaid?
    #
    #        The following were modified for Phase 3.7
    #         * School Food < Do any of the children in the household ... (USED to be in last 7 days)
    #                         schlfdhlp_rv1 - schlfdhlp_rv8
    #
    #        We removed the following indicators for Phase 3.7
    #         
    #         
    #         
    #         
...
## Load survey & replicate weights ----
    ...
    setwd(paste0(inputdir, "phase3_7_unzipped/"))
