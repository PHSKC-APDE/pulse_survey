## Header ----
    ...
    # Date: March 29, 2023
    # R version: 4.2.1
    # Purpose: append and prep all individual PULSE 3.8 survey files for analysis
    #
    ...
    #
    # Notes: Phase 3.8 began with week 55 (March 1-13, 2023) and is scheduled to continue two additional survey weeks.
    #        The survey is the same as 3.7 except for question FD6, which asks if the household is receiving 
    #        SNAP, WIC, or 'none of these'. 
    # 
    #        We added following indicators for Phase 3.8
    #          fdbenefitsnap << Do you or anyone in your household receive benefits from SNAP?
    #          fdbenefitwic  << Do you or anyone in your household receive benefits from WIC?
    #          fdbenefitnone << Do you or anyone in your household receive benefits from None of these (neither SNAP nor WIC)?
    #
    #        No indicators were modified for Phase 3.8
    #
    #        No indicators were removed for Phase 3.8         
    #         
    #         
...
## Load survey & replicate weights ----
    ...
    setwd(paste0(inputdir, "phase3_8_unzipped/"))
