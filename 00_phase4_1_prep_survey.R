## Header ----
    ...
    #
    # Notes: Phase 4.0 began on January 9, 2024. The phase introduces cycles to replace the survey 'weeks'. 
    #        Phase 4.0 will have three cycles:
    #           * Cycle 1: Jan 9 - Feb 5, 2024
    #           * Cycle 2: Feb 6 - Mar 4, 2024
    #           * Cycle 3: Mar 5 - Apr 1, 2024
    # 
    #        The survey has multiple changes compared to Phase 3.10. The ones which impact this analysis
    #        are list below:
    #        ---NEW VARS---
    ...
    #           * SOCInd4: How often do you attend meetings of the clubs or organizations you belong to?
    ...
    #
    #        ---DROPPED VARS---
    #           * medicaid vars of every flavor
    #           * hlth_mhchld[1-9] ... this is not listed in documentation, but the question is not in the questionnaire
    #             and the vars are no in the dataset
    #
