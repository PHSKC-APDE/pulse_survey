## Header ----
    ...
    #
    # Notes: Phase 4.0 began on April 2, 2024 and will continue for four cycles (4-7) until July 22, 2024. 
    #
    #        ---ANNOYING VARS---
    #           * forclosure is now foreclosure, but contents are the same
    #
    #        ---CHANGED VARS---
    #           * support4 is now support4_rv ... functionally same question, but different options:
    #             support4 - 'How often do you attend meetings of the clubs or organizations you belong to?'
    #                         < 1/week, 1-2/week, 3-4/week, 5+/week
    #             support4_rv - 'Altogether, how often do you attend meetings of clubs or organizations you belong to, 
    #                            such as church groups, unions, fraternal or athletic groups, or school groups?'
    #                         < don't below to a group, never or < 1/year, 1-3/year, 4-11/year, 12+/year
    #
    #        ---DROPPED VARS---
    #           * no relevant changes
    #
