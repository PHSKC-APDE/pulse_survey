...
## Survey Set for WA & MSA ----
    # Washington ----
        svy_wa3_3 <- survey_set_weekly(dt[washington==1])
        pooledN_svy_wa3_3 <- survey_set_pooled(dt[washington==1])

    # MSA ----
        svy_msa3_3 <- survey_set_weekly(dt[msa==1])
        pooledN_svy_msa3_3 <- survey_set_pooled(dt[msa==1])
