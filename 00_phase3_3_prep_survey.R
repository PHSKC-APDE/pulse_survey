...
## Survey Set for WA & MSA ----
    # Washington ----
        pooledN_svy_wa3_3 <-  # PHASE 3.1 in Washington
          srvyr::as_survey_rep(
        ...
        pooledN_svy_wa3_3 <- dtsurvey::dtrepsurvey(pooledN_svy_wa3_3)
        
        svy_wa3_3 <-  # PHASE 3.1 in Washington (for individual weeks)
          srvyr::as_survey_rep(
            copy(dt[washington==1])  ,
            weights = pweight ,
            combined.weights = TRUE ,
        ...
        svy_wa3_3 <- dtsurvey::dtrepsurvey(svy_wa3_3)
        
    # MSA ----
        pooledN_svy_msa3_3 <-   # PHASE 3.1 in Seattle-Tacoma-Bellevue
          srvyr::as_survey_rep(
            copy(dt[msa==1])  ,
            weights = pooledNwt ,
            combined.weights = TRUE ,
        ...
        pooledN_svy_msa3_3 <- dtsurvey::dtrepsurvey(pooledN_svy_msa3_3)
        
        
        svy_msa3_3 <-   # PHASE 3.1 in Seattle-Tacoma-Bellevue (for individual weeks)
          srvyr::as_survey_rep(
            copy(dt[msa==1])  ,
            weights = pweight ,
            combined.weights = TRUE ,
        ...
        svy_msa3_3 <- dtsurvey::dtrepsurvey(svy_msa3_3)
