## Header ----
    ...
    #
    # Notes: Phase 3.6 differs from previous phases and will be analyzed separately
    #        refer to notes in 00_phase3_6_prep_survey.R for details. 
    #        Phase 3.6 begins with week 49 (Sep 14 - 26, 2022)
    #
    # Needs rads >= v1.0.0
...
## Identify columns for calculations ----
    ...
    vaccine_vars <- c() # no longer process vaccine related vars as of the start of Phase 3.6 (week 49)
...
## Use rads to perform calculations ----
    ...
    # Vaccine: by week (no longer as of Phase 3.6) ----
      
    # Vaccine: pooled demographics (no longer as of Phase 3.6) ----
