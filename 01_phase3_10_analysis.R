## Header ----
    ...
    #
    # Notes: Phase 3.10 differs from previous phases and will be analyzed separately
    #        Phase 3.10 begins with week 61 (Aug 23 - Sept 4, 2023)
    #
    # Needs rads >= v1.0.0
...
## Set up ----
    ...
    # set constants ----
    phase.number <- "3.10"
    phase_number <- "3_10" # have to give this value a second time because creating the analysis dataset
    first.week <- 61 # identify the first week of the current phase
...
## Use rads to perform calculations ----
    ...
    # Housing: pooled demographics ----
        ...
        # housing.grid.noncat <- setDT(expand.grid(myvars = housing_vars_noncat, byvars = mybyvars)) # ended Phase 3.10
